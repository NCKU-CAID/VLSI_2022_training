void boot() {
	...
	extern unsigned int __sdata_start;//Main_data start address in DRAM
	extern unsigned int __sdata_end;//Main_data end address in DRAM
	extern unsigned int __sdata_paddr_start;//= Main_data start address in DM

	extern unsigned int __data_start;//Main_data start address in DRAM
	extern unsigned int __data_end;//Main_data end address in DRAM
	extern unsigned int __data_paddr_start;//Main_data start address in DM
