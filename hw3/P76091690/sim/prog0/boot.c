void boot() {
	extern unsigned int _dram_i_start;       //inst start address in DRAM
	extern unsigned int _dram_i_end;         //inst end address in DRAM
	extern unsigned int _imem_start;         //inst start address in IM
